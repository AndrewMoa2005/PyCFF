...
class Widget(QWidget):
    def __init__(self, parent=None):
        ...
        self.ui.copyPlotBtn.clicked.connect(self.onCopyPlotBtnClicked)
    ...
    def onCopyPlotBtnClicked(self):
        ...
        svg_btn.clicked.connect(self.copySVG)
        self.copyPlotDialog.exec()
    ...
    def copySVG(self):
        ...
        generator.setSize(QSize(self.chartView.width(), self.chartView.height()))
        generator.setViewBox(
            QRect(0, 0, self.chartView.width(), self.chartView.height())
        )
        generator.setTitle(self.ui.titleIn.text())
        ...
        qDebug("Copy SVG format image to clipboard")
        self.copyPlotDialog.close()
    ...
    def onLoadBtnClicked(self):
        path, _ = QFileDialog.getOpenFileName(
            ...
            "",
            self.tr(
                "CSV Files (*.csv);;Excel Files (*.xlsx);;Excel 97-2003 Files (*.xls);;All Files (*)"
            ),
        )
        if not path:
            return
